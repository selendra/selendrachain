...
struct TestState {
	...
	polkadot-v0.9.6_keystore: Arc<sc_keystore::LocalKeystore>,
...
impl Default for TestState {
	fn default() -> TestState {
		...
		let polkadot-v0.9.6_keystore = make_keystore(&validators).into();
...
impl TestState {
	...
	async fn issue_statement_with_index(
		...
		let keystore = self.polkadot-v0.9.6_keystore.clone() as SyncCryptoStorePtr;
