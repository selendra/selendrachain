...
use frame_support::{
	...
	pallet_prelude::*,
	traits::{
		Currency, ExistenceRequirement, Imbalance,NamedReservableCurrency,
		OnUnbalanced, SameOrOther, WithdrawReasons,
	},
	weights::{
		DispatchInfo, GetDispatchInfo, Pays, 
		PostDispatchInfo,WeightToFeePolynomial
	},
};
...
use primitives::{Balance, currency::CurrencyId, evm::ReserveIdentifier};
use sp_runtime::{
	traits::{
		CheckedSub, Convert, DispatchInfoOf, PostDispatchInfoOf,
