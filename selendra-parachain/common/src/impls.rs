...
//! Taken from selendra/runtime/common (at a21cd64) and adapted for Statemint.
...
where
	...
	<R as frame_system::Config>::AccountId: From<selendra_primitives::v1::AccountId>,
	<R as frame_system::Config>::AccountId: Into<selendra_primitives::v1::AccountId>,
