...
pub use selendra_parachain_common::{
...
pub use selendra_parachain_common as common;
use selendra_parachain_common::impls::DealWithFees;
...
parameter_types! {
	pub const AssetDeposit: Balance = SELS; // 1 SELS deposit to create asset
	pub const ApprovalDeposit: Balance = EXISTENTIAL_DEPOSIT;
	pub const StringLimit: u32 = 50;
	/// Key = 32 bytes, Value = 36 bytes (32+1+1+1+1)
	// https://github.com/selendra/substrate/blob/069917b/frame/assets/src/lib.rs#L257L271
...
parameter_types! {
	pub const ClassDeposit: Balance = SELS; // 1 UNIT deposit to create asset class
	pub const InstanceDeposit: Balance = SELS / 100; // 1/100 UNIT deposit to create asset instance
...
parameter_types! {
	pub const SelLocation: MultiLocation = MultiLocation::X1(Junction::Parent);
