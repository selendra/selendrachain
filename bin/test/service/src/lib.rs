...
use selendra_node_subsystem::messages::{CollatorProtocolMessage, CollationGenerationMessage};
use selendra_test_runtime::{
	Runtime, SignedExtra, SignedPayload, VERSION, ParasSudoWrapperCall, SudoCall, UncheckedExtrinsic,
};
use selendra_node_primitives::{CollatorFn, CollationGenerationConfig};
...
native_executor_instance!(
	pub SelendraTestExecutor,
	selendra_test_runtime::api::dispatch,
	selendra_test_runtime::native_version,
	frame_benchmarking::benchmarking::HostFunctions,
);

/// The client type being used by the test service.
pub type Client = FullClient<selendra_test_runtime::RuntimeApi, SelendraTestExecutor>;
...
pub fn run_validator_node(
	...
	let NewFull { task_manager, client, network, rpc_handlers, overseer_handler, .. } =
		new_full(config, IsCollator::No, worker_program_path).expect("could not create Selendra test service");
...
impl SelendraTestNode {
	...
	pub async fn send_extrinsic(
		&self,
		function: impl Into<selendra_test_runtime::Call>,
...
pub fn construct_extrinsic(
	...
	UncheckedExtrinsic::new_signed(
		...
		selendra_primitives::v0::Signature::Sr25519(signature.clone()),
		extra.clone(),
	)
}
...
pub fn construct_transfer_extrinsic(
	...
	let function = selendra_test_runtime::Call::Balances(
