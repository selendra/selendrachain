...
pub trait InitSelendraBlockBuilder {
	...
	fn init_selendra_block_builder(&self) -> sc_block_builder::BlockBuilder<Block, Client, FullBackend>;
...
pub trait BlockBuilderExt {
	...
	fn push_selendra_extrinsic(&mut self, ext: UncheckedExtrinsic) -> Result<(), sp_blockchain::Error>;
}
