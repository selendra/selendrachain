...
use indracore_primitives::v1::{
    ...
    CandidateEvent, CandidateHash, CandidateReceipt, CollatorId, CommittedCandidateReceipt,
    CoreState, ErasureChunk, GroupRotationInfo, Hash, Header as BlockHeader, Id as ParaId,
    InboundDownwardMessage, InboundHrmpMessage, OccupiedCoreAssumption, PersistedValidationData,
    PoV, SessionIndex, SessionInfo, SignedAvailabilityBitfield, ValidationCode, ValidationData,
...
pub enum CollatorProtocolMessage {
    ...
    FetchCollation(
        ...
        CollatorId,
        ParaId,
        oneshot::Sender<(CandidateReceipt, PoV)>,
    ),
