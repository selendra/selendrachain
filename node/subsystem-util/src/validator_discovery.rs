...
use indracore_primitives::v1::{
    AuthorityDiscoveryId, Hash, Id as ParaId, SessionIndex, ValidatorId,
};
...
impl ConnectionRequests {
    ...
    pub fn contains_request(&self, relay_parent: &Hash, para_id: ParaId) -> bool {
        self.id_map
            .get(relay_parent)
            .map_or(false, |map| map.contains_key(&para_id))
    }
