...
use indracore_node_primitives::{CollationGenerationConfig, CollatorFn};
...
use indracore_primitives::v1::{
    Balance, CollatorId, CollatorPair, HeadData, Id as ParaId, ValidationCode,
};
use indracore_runtime_common::BlockHashCount;
use indracore_runtime_parachains::paras::ParaGenesisArgs;
use indracore_service::{ClientHandle, Error, ExecuteWithClient, FullClient, IsCollator, NewFull};
...
pub fn run_collator_node(
    ...
    let NewFull {
        ...
        overseer_handler,
        ..
    } = new_full(config, IsCollator::Yes(collator_id))
        .expect("could not create Indracore test service");
