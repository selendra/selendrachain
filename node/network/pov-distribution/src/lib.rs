...
use indracore_node_network_protocol::{
    peer_set::PeerSet, v1 as protocol_v1, OurView, PeerId, UnifiedReputationChange as Rep,
};
...
const BENEFIT_LATE_POV: Rep = Rep::BenefitMinor(
...
async fn handle_distribute(
    ...
    relay_parent_state
        .known
        .insert(descriptor.pov_hash, (pov, encoded_pov));
}
...
async fn handle_incoming_pov(
    ...
    relay_parent_state
        .known
        .insert(pov_hash, (pov, encoded_pov));
}
