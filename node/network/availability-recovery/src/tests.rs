...
impl TestState {
    ...
    async fn test_connect_to_validators(&self, virtual_overseer: &mut VirtualOverseer) {
...
impl Default for TestState {
    fn default() -> Self {
        ...
        let (chunks, erasure_root) =
            derive_erasure_chunks_with_proofs_and_root(validators.len(), &available_data);
...
fn availability_is_recovered() {
    ...
    test_harness(|test_harness| async move {
        ...
        test_state
            .test_connect_to_validators(&mut virtual_overseer)
            .await;
