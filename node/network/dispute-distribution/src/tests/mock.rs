...
use selendra_node_network_protocol::{PeerId, authority_discovery::AuthorityDiscovery};
...
impl AuthorityDiscovery for MockAuthorityDiscovery {
	async fn get_addresses_by_authority_id(&mut self, _authority: selendra_primitives::v1::AuthorityDiscoveryId)
		-> Option<Vec<sc_network::Multiaddr>> {
			panic!("Not implemented");
	}

	async fn get_authority_id_by_peer_id(&mut self, peer_id: selendra_node_network_protocol::PeerId)
