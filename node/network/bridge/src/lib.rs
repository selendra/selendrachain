...
use indracore_subsystem::{
    ActivatedLeaf, ActiveLeavesUpdate, FromOverseer, OverseerSignal, SpawnedSubsystem, Subsystem,
...
async fn update_our_view(
    ...
    send_collation_message(net, collation_peers, WireMessage::ViewUpdate(new_view)).await?;
