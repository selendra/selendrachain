...
struct ChannelsOut {
    ...
    candidate_selection_unbounded:
        metered::UnboundedMeteredSender<MessagePacket<CandidateSelectionMessage>>,
    ...
    fn send_unbounded_and_log_error(&self, signals_received: usize, message: AllMessages) {
        let res = match message {
            ...
            AllMessages::CandidateBacking(msg) => self
                ...
                .unbounded_send(make_packet(signals_received, msg))
                .map_err(|e| e.into_send_error()),
            AllMessages::CandidateSelection(msg) => self
                .candidate_selection_unbounded
                .unbounded_send(make_packet(signals_received, msg))
                .map_err(|e| e.into_send_error()),
    ...
    S: SpawnNamed,
{
        ...
        GS: Subsystem<OverseerSubsystemContext<GossipSupportMessage>> + Send,
    {
        ...
        let candidate_selection_subsystem = spawn(
            ...
            stream::select(
                candidate_selection_bounded_rx,
                candidate_selection_unbounded_rx,
            ),
