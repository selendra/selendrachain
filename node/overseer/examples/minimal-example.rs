...
use indracore_subsystem::{FromOverseer, SpawnedSubsystem, Subsystem, SubsystemContext};
...
fn main() {
    ...
    futures::executor::block_on(async {
        ...
        let (overseer, _handler) = Overseer::new(vec![], all_subsystems, None, spawner).unwrap();
