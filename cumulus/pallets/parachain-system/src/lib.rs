...
use indracore_parachain::primitives::RelayChainBlockNumber;
...
impl<T: Config> Module<T> {
    ...
    /// [`ValidationParams`](indracore_parachain::primitives::ValidationParams).
    ///
    ...
    fn schedule_upgrade_impl(validation_function: Vec<u8>) -> DispatchResult {
        ...
        //
        // `notify_indracore_of_pending_upgrade` notifies polkadot; the `PendingValidationFunction`
