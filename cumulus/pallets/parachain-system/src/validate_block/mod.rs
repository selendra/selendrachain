...
use indracore_parachain::primitives::ValidationParams;
    ...
    ($runtime:ty, $block_executor:ty) => {
        ...
        mod parachain_validate_block {
            ...
            unsafe fn validate_block(arguments: *const u8, arguments_len: usize) -> u64 {
                let params = $crate::validate_block::indracore_parachain::load_params(
                    arguments,
                    arguments_len,
                );
                ...
                $crate::validate_block::indracore_parachain::write_result(&res)
            }
        }
    };
}
