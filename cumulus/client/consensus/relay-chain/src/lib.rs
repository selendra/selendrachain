    ...
    RBackend: Backend<PBlock>,
{
    ...
    pub fn new(
        ...
        inherent_data_providers: InherentDataProviders,
        block_import: BI,
        indracore_client: Arc<RClient>,
        indracore_backend: Arc<RBackend>,
    ) -> Self {
        Self {
            para_id,
            ...
            relay_chain_backend: indracore_backend,
            relay_chain_client: indracore_client,
            _phantom: PhantomData,
        }
    }
...
pub struct BuildRelayChainConsensusParams<PF, BI, RBackend> {
    ...
    pub block_import: BI,
    pub relay_chain_client: indracore_service::Client,
...
impl<Block, PF, BI, RBackend> indracore_service::ExecuteWithClient
