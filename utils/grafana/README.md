...
Selendra nodes collect and produce Prometheus metrics and logs. These include health, performance and debug 
information such as last finalized block, height of the chain, and many other deeper implementation details 
of the Selendra/Substrate node subsystems. These are crucial pieces of information that one needs to successfully 
...
[guide](https://wiki.selendra.network/docs/maintain-guides-how-to-monitor-your-node). 
...
(see [installing and configuring Alert Manager](https://wiki.selendra.network/docs/maintain-guides-how-to-monitor-your-node#installing-and-configuring-alertmanager-optional))
...
[Dashboard JSON](general/cardamom_deployment.json)
...
finalized. It was originally designed for observing liveliness after parachain deployment in
 Cardamom/Selendra, but can be useful generally in production or testing.
