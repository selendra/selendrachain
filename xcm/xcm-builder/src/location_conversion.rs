...
impl<Network: Get<NetworkId>, AccountId: From<[u8; 32]> + Into<[u8; 32]>>
...
impl<AccountId: Default + Eq> LocationConversion<AccountId> for ParentIsDefault<AccountId> {
    fn from_location(location: &MultiLocation) -> Option<AccountId> {
...
impl<ParaId: From<u32> + Into<u32> + AccountIdConversion<AccountId>, AccountId>
