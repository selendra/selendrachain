...
pub use selendra_parachain::primitives::{Id as ParaId, UpwardMessage, ValidationParams};
...
pub mod relay_chain {
	...
	pub use selendra_primitives::{v1, v1::well_known_keys};
}
use relay_chain::BlockNumber as RelayBlockNumber;

/// An inbound HRMP message.
pub type InboundHrmpMessage = selendra_primitives::v1::InboundHrmpMessage<relay_chain::BlockNumber>;

/// And outbound HRMP message
pub type OutboundHrmpMessage = selendra_primitives::v1::OutboundHrmpMessage<ParaId>;
