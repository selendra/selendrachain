...
chainspec="cardamom-local"

# disabled until we can actually successfully register the chain with polkadot-js-api
# if ! command -v selendra-js-api > /dev/null; then
#   echo "selendra-js-api required; try"
#   echo "  sudo yarn global add @selendra/api-cli"
#   exit 1
# fi
...
# doesn't work yet due to https://github.com/selendra-js/tools/issues/185
# selendra-js-api \
