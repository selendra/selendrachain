...
impl<R: frame_system::Config> IndracorePrecompiles<R> {
...
/// Indracore specific
impl<R: frame_system::Config + pallet_evm::Config> PrecompileSet for IndracorePrecompiles<R>
where
	...
	<R::Call as Dispatchable>::Origin: From<Option<R::AccountId>>,
{
	fn execute(
		...
		match address {
			...
			// Non-Indracore specific nor Ethereum precompiles :
