...
use sp_std::{
	cmp::Ordering, collections::btree_map::BTreeMap, convert::TryFrom, marker::PhantomData,
	prelude::*,
};
...
parameter_types! {
	...
	pub const EnactmentPeriod: BlockNumber = 40 * MINUTES;
	pub const CooloffPeriod: BlockNumber = 30 * MINUTES;
	// One cent: $10,000 / MB
...
parameter_types! {
	pub const CouncilMotionDuration: BlockNumber = 26 * MINUTES;
...
parameter_types! {
	pub const TechnicalMotionDuration: BlockNumber = 26 * MINUTES;
...
parameter_types! {
	...
	pub const SelendraForParachanin: (MultiAssetFilter, MultiLocation) = (Selendra::get(), Parachain(1000).into());
}
pub type TrustedTeleporters = (xcm_builder::Case<SelendraForParachanin>,);
