...
pub mod constants;
use constants::{currency::*, fee::*, time::*, merge_account::MergeAccountEvm};
...
parameter_types! {
	...
	pub const SelendraForStatemint: (MultiAssetFilter, MultiLocation) = (Selendra::get(), Parachain(1000).into());
}
