...
impl<T: frame_system::Config> pallet_staking::WeightInfo for WeightInfo<T> {
    ...
    fn set_validator_count() -> Weight {
        (2_185_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_no_eras() -> Weight {
        (2_462_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_new_era() -> Weight {
        (2_457_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_new_era_always() -> Weight {
        (2_479_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
