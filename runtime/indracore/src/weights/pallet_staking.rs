...
impl<T: frame_system::Config> pallet_staking::WeightInfo for WeightInfo<T> {
    ...
    fn set_validator_count() -> Weight {
        (2_151_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_no_eras() -> Weight {
        (2_354_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_new_era() -> Weight {
        (2_348_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
