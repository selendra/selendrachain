...
use sp_runtime::{
    traits::{AccountIdConversion, Bounded, CheckedAdd, Hash, Saturating, Zero},
...
mod tests {
    ...
    fn contribute_handles_basic_errors() {
        new_test_ext().execute_with(|| {
            ...
            assert_noop!(
                Crowdloan::contribute(Origin::signed(1), 0, 49),
                Error::<Test>::InvalidFundIndex
            );
            // Cannot contribute below minimum contribution
            assert_noop!(
                Crowdloan::contribute(Origin::signed(1), 0, 9),
            ...
            assert_noop!(
                Crowdloan::contribute(Origin::signed(2), 0, 900),
