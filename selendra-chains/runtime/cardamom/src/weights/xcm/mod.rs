...
/// Types of asset supported by the cardamom runtime.
pub enum AssetTypes {
...
// Cardamom only knows about one asset, the balances pallet.
...
pub struct CardamomXcmWeight<Call>(core::marker::PhantomData<Call>);
impl<Call> XcmWeightInfo<Call> for CardamomXcmWeight<Call> {
	...
	fn reserve_asset_deposited(_assets: &MultiAssets) -> Weight {
		// Cardamom does not support reserve asset deposits.
		Weight::MAX
	}
